# Project 2 - *SimleTweet part 2*

**SimleTweet part 2** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/pascodev7/SimpleTweet/blob/master/walkthrough_SimpleTweet.gif' title=Walkthrough_SimpleTweet width='' alt='Video Walkthrough' />
